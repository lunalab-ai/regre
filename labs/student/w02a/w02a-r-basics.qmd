...
![R 엔진과 RStudio 작업 화면의 관계](../../../course/notion/w02a/assets/rstudio-map.png)
...
![스크립트 파일과 실행 중인 객체의 차이](../../../course/notion/w02a/assets/script-memory.png)
...
![벡터를 데이터프레임의 열로 묶는 과정](../../../course/notion/w02a/assets/vector-table.png)
